...
namespace Exercises.DecisionTree
{
    public class Option
    {
        ...
        public static Question NextQuestion(List<Option> options, string reply, Question defaultAnswer) =>
            options.FirstOrDefault(option => option._option == reply)?._question.NextQuestion() ?? defaultAnswer.NextQuestion();
    }
}
...
namespace Exercises.DecisionTree
{
    ...
    public static class QuestionExtensions
    {
        ...
        public static Question text(this Question question) => question;
